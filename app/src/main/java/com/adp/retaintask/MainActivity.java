 ...
 * changes occur.When it will happen fragment will call onPause,OnDestroyView and onDetach but not onDestroy
 * so activity will keep fragment instance during rotation changes.In MainActivity we will check for existing
 * fragment instance to prevent creating new instance onCreate after rotation.Retained fragment will
 * update new Activity instance's context onAttach every time ,so it won't update old activity instance
 */
